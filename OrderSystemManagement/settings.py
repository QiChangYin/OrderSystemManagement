"""
Django settings for OrderSystemManagement project.
...
ROOT_URLCONF = 'OrderSystemManagement.urls'
...
WSGI_APPLICATION = 'OrderSystemManagement.wsgi.application'
